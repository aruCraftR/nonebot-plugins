        ...
        for i in shared.plugin_config.mcsm_instances_list:
            try:
                await AsyncMcsmAPI.send_command(i, [
                    ...
                    """tellraw @a[tag=admin] {"text":"[QQ提醒] 有新的入群申请待审批","bold":true,"underlined":true,"color":"red","clickEvent":{"action":"open_url","value":"https://wj.qq.com/stat/1/recycle?sid=12682162"},"hoverEvent":{"action":"show_text","contents":[{"text":"点击前往问卷收集页","color":"green"}]}}"""
                ])
            except Exception as e:
